...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Gustavo%20Mantellis&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Big%20Data%20%7C%20IoT%20%7C%20Cloud%20%7C%20Agronegócio&descAlignY=55&descSize=18" width="100%"/>

<a href="https://readme-typing-svg.demolab.com">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=800&color=58A6FF&center=true&vCenter=true&multiline=false&width=600&lines=Estudante+de+Big+Data+no+Agroneg%C3%B3cio+%F0%9F%8C%BF;IoT+Developer+com+ESP32+%2B+Firebase+%F0%9F%90%9F;Cloud+%7C+AWS+%7C+Python+%F0%9F%9A%80;Transformando+dados+em+decis%C3%B5es+%F0%9F%93%8A" alt="Typing SVG" />
</a>
...
class GustavoMantellis:
    def __init__(self):
        ...
        self.paixoes    = ["Agronegócio + Tecnologia", "ESP32", "AWS", "Machine Learning"]
        self.buscando   = "1ª oportunidade em Data Analytics, BI ou Suporte TI"

    def atual(self):
        return {
            "aprendendo" : ["AWS Solutions Architect", "Power BI Avançado", "MLOps"],
...
📌 Power BI Avançado — DAX & modelagem de dados
